...
public class TranslationRequestRepository {
    ...
    public void save(TranslateDto translateDto) {
        String sql = "INSERT INTO TranslationRequests (userIp, sourceLang, targetLang, inputText, translatedText, timestamp) " +
                "VALUES (?, ?, ?, ?, ?, ?)";
        jdbcTemplate.update(sql, translateDto.getUserIp(), translateDto.getSourceLang(), translateDto.getSourceLang(),
